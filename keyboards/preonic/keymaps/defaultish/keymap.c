 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Esc  | Ctrl | Ctrl | GUI  |Lower | GUI  |Enter | Spc  | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_preonic_grid( \
  ...
  KC_ESC,  KC_LCTL, KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_ENT,  KC_SPC,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
),
...
[_LOWER] = LAYOUT_preonic_grid( \
  ...
  TD(TD_KEY_2), _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
  TD(TD_KEY_1), _______, _______, _______, _______, _______, _______, _______, _______, KC_LBRC, KC_RBRC, _______  \
),
